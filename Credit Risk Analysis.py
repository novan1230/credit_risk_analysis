# -*- coding: utf-8 -*-
"""Salinan dari Salinan dari CreditRiskAnalysis_idx.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1O2lHnUupYkflnXnY67l3UCUn2CCCx8ZT
...
In order to optimize risk management, multifinance companies are trying to improve creditworthiness assessment methods. Approval given to borrowers with a high risk of default has the potential to **reduce the company's financial performance**. In addition, errors in evaluating a borrower's credit risk can be fatal for a finance company. Therefore, **improving assessment** capabilities is **crucial to avoid losses due to bad debts**.  

<br>


### **🧠 Business Problem**
How to **identify the risk of customer** default through historical data analysis to **improve the accuracy of credit** assessment by companies, so that companies can make more informed lending decisions?
...
plt.figure(figsize=(9, 4), dpi=100, facecolor='white')
ax = plt.subplot(111)
...
ax.set_title('Model Performance Comparison', pad=20, fontsize=15, fontweight='bold')
ax.set_facecolor('white')
...
`loan_status_Does not meet the credit policy`
...
`loan_status_Late` **and** `loan_status_Default`
